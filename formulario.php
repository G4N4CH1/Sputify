...
$titulo_pagina= "Formulario de Cadastro de Filmes";
require 'conexao.php';
    ...
    <div class="row">
        <div class="col-7">
              ...
              <label for="stream" class="form-label">Streaming:</label>
               <select class="form-select" name="stream" id="stream">
                ...
                while($rowstream=$stmtstream->fetch()){
                  ...
                  <option value="<?=$rowstream["id"]?>"><?=$rowstream["nome"]?></option>
            ...
            <div class="mb-3">
              ...
              <input type="url" class="form-control" id="poster" name="poster" aria-describedby="urlfotoHelp" required>
            ...
            <div class="mb-3">
              ...
              <input type="number" class="form-control" id="ano" name="ano" required min="1888" max="2100">
            </div>
